...
while True:
    ...
    #line-spring
    pygame.draw.lines(screen, spring, False, [(100,290),(180+int(x),290)], 5)
    
    #parede
    pygame.draw.rect(screen, gray, (100,200,10,120), 0)
    #chao
    pygame.draw.rect(screen, gray, (100,310,220,10), 0)
    
    
    #box
    pygame.draw.rect(screen, box, (180+int(x),270,40,40), 0)
